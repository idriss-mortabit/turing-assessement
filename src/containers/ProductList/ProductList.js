...
const mapStateToProps = state => {
    ...
    const searchTerm = state.searchFilter;

    const filterBySearchArr = searchFilter(state.shop.products, searchTerm);
    const filterByBrandArr = brandFilter(filterBySearchArr, brands);
